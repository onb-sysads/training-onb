<%@ page import="com.mysql.*, java.sql.*" language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
				...
				<form method="POST" action="UserAuthentication.do">
						...
						<table  align="center" id="loginTable">
							<tr>
								...
								<td align="right"><input type="text" maxlength="20" name="username"></input></td>
							</tr>
							<tr>
								<td><strong><font size="2px" face="arial" color=#686868>Password:</font></strong></td>
								<td align="right"><input type="password" maxlength="20" name="password"></input></td>
							</tr>
							<tr>
								<td></td>
								<td align="right">
